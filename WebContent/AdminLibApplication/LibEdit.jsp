...
<div id="form-wrapper" style="max-width:500px;margin:auto; text-align: center;">
    ...
    <input type="email" class="form-control" name="lemail" value="<%=rs.getString(5)%>" pattern="[a-zA-Z]{3,}.+@americantower.com" title="Format of email id is name@americantower.com" required/>
</div>
<div id="form-wrapper" style="max-width:500px;margin:auto; text-align: center;">
    <label for="name1">Address</label>
    <input type="text" class="form-control" name="laddress" value="<%=rs.getString(6)%>" readonly/>
</div>
<div id="form-wrapper" style="max-width:500px;margin:auto; text-align: center;">
    <label for="name1">City</label>
    <input type="text" class="form-control" name="lcity" value="<%=rs.getString(7)%>" readonly/>
</div>
<div id="form-wrapper" style="max-width:500px;margin:auto; text-align: center;">
